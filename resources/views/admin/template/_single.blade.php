...
@if(!is_null($record))
    @section('title', substr($record->subject, 0, 80))
@else
...
@section('title_right_section')
    <div class="pull-right">
        <a class="btn btn-success" href="{{ CustomHelper::getPageUrl($pageRoute . '.edit', [$record->id]) }}">Edit Template</a>
...
@section('content')
    ...
    @if(is_null($record))
        <div class="alert alert-warning">Invalid Template</div>
    @else
                                            ...
                                            <li>
                                                ...
                                                <div class="message_wrapper">
                                                    ...
                                                    <p class="url">
                                                        ...
                                                        <a href="#"><i class="fa fa-paperclip"></i> Post Acceptance Test.doc </a>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
